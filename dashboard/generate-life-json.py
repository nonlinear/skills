#!/usr/bin/env python3
"""
Generate data/personal.json from personal ROADMAP.md
Run: python3 ~/Documents/apps/agenda/generate-life-json.py
"""
import json
import os
import re

ROADMAP_PATH = os.path.expanduser("~/Documents/personal/backstage/ROADMAP.md")
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "data", "personal.json")
...
if __name__ == "__main__":
    print("🔄 Generating personal.json from personal ROADMAP.md...")
    data = parse_roadmap()
