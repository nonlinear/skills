...
**2️⃣** One diagram per contract: Multiple diagrams = noise, breaks muscle memory. If needed: create separate files (deployment-contract.md, data-contract.md).

**3️⃣** Contract phases (meta-flow):
